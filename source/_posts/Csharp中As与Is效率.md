...
先判断obj是不是T类型，如果是再进行转换。![1](/images/Csharp中As与Is效率/1.PNG)
...
![2](/images/Csharp中As与Is效率/2.PNG)
![3](/images/Csharp中As与Is效率/3.PNG)
