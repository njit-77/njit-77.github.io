...
(将二进制中的基元类型写入流并支持用特定的编码写入字符串。) 详细介绍参考[msdn](https://msdn.microsoft.com/zh-cn/library/system.io.binarywriter(v=vs.110).aspx)
...
(用特定的编码将基元数据类型读作二进制值。)详细介绍参考[msdn](https://msdn.microsoft.com/zh-cn/library/system.io.binaryreader(v=vs.110).aspx)
...
详细介绍参考[msdn](https://msdn.microsoft.com/zh-cn/library/system.io.streamwriter(v=vs.110).aspx)
...
详细介绍参考[msdn](https://msdn.microsoft.com/zh-cn/library/system.io.stringreader(v=vs.110).aspx)
