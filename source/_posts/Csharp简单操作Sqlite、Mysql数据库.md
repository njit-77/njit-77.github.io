...
##### 使用Visual Studio 2022创建控制台应用（.NET Framework）,框架选择‘.NET Framework 4.6.2’

##### 通过nuget下载 NewLife.Core、NewLife.XCode库
...
![sqlite-1](/images/Csharp简单操作Sqlite、Mysql数据库/sqlite-1.png)

![sqlite-2](/images/Csharp简单操作Sqlite、Mysql数据库/sqlite-2.png)
...
![mysql-1](/images/Csharp简单操作Sqlite、Mysql数据库/mysql-1.png)

![mysql-2](/images/Csharp简单操作Sqlite、Mysql数据库/mysql-2.png)
